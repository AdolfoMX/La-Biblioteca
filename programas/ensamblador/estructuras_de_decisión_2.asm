...
; Simulando la sentencia if-else
...
mov ebx, 9             ; almacenando el valor 9

cmp eax, 5             ; comparación del registro eax con 5
jz cuerpoif            ; si la comparación es igual manda un 1 desde cuerpoif

cuerpoelse:            ; condicional si no se cumple la función cuerpoif
mov ebx, 0             ; almacena un valor 0 cuando el valor no es igual
